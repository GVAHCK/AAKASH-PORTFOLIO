				...
				>
					...
					>
						...
						>
							...
							<b className="text-neutral-200">Cloud Infrastructure</b>. Currently working on
							Azure security at{" "}
							<b className="text-neutral-200">Gen-Z Galaxy Tech</b> and building{" "}
							<b className="text-neutral-200">decentralized systems</b>. Focused on the
							intersection of{" "}
							<span className="text-teal-400">Cloud Security</span>,{" "}
							<span className="text-teal-400">Blockchain</span>, and{" "}
						...
						>
							...
							<a
								href="https://res.cloudinary.com/domogztsv/image/upload/v1771015396/autoCV_2__page-0001_b9y8ib.jpg"
								download="Aakash_Resume.jpg"
								target="_blank"
									...
									if (
										...
										(globalThis.window as any).gtag(
											...
											"resume_download",
											{
												...
												event_label: "Resume Image Download",
											},
										);
									}
								}}
