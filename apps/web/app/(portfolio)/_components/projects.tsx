...
const projectsData: Project[] = [
  {
    id: 'dacc',
    title: 'DACC — Decentralized Adaptive Cryptographic Cloud',
    status: 'Active',
    statusVariant: 'active',
    description:
      'Designed an agent-centric decentralized cloud architecture for secure hospital and government data storage using Holochain. Eliminated centralized control points while ensuring data privacy, availability, and fault tolerance.',
    techStack: ['Holochain', 'Rust', 'Cryptography', 'Decentralized Systems'],
    githubLink: 'https://github.com/GVAHCK',
  },
  {
    id: 'vortex',
    title: 'Vortex — AI-Powered Security Analyst',
    status: 'Active',
    statusVariant: 'active',
    description:
      'Developed an autonomous security analyst agent using LangChain and Python. Capable of analyzing log files, detecting anomalies, and suggesting remediation steps in real-time, significantly reducing incident response time.',
    techStack: ['Python', 'LangChain', 'OpenAI API', 'Vector DB'],
    githubLink: 'https://github.com/GVAHCK',
  },
  {
    id: 'nebula',
    title: 'Nebula — Zero-Knowledge Identity Protocol',
    status: 'Active',
    statusVariant: 'active',
    description:
      'Implemented a privacy-preserving identity verification protocol using Zero-Knowledge Proofs. Allows users to prove attributes (age, citizenship) without revealing underlying data, ensuring compliance with privacy regulations.',
    techStack: ['Solidity', 'Circom', 'React', 'Ethers.js'],
    githubLink: 'https://github.com/GVAHCK',
  },
  {
    id: 'ayusetu',
    title: 'AYUSETU — Dual-Layer Blockchain Traceability',
    status: 'Active',
    statusVariant: 'active',
    description:
      'Built a dual-layer blockchain system to trace Ayurvedic herbs from cultivation to final product. Improved transparency, authenticity, and regulatory compliance across the herbal supply chain.',
    techStack: ['Blockchain', 'Solidity', 'ReactJS', 'NodeJS', 'MongoDB'],
    githubLink: 'https://github.com/GVAHCK',
  },
  {
    id: 'holo-cast',
    title: 'Holo Cast — Android Application',
    status: 'Showcase',
    statusVariant: 'showcase',
    description:
      'Developed an Android video calling application with real-time 3D object integration, enabling immersive communication experiences.',
    techStack: ['Android Studio', 'Java', 'AR/3D', 'WebRTC'],
    githubLink: 'https://github.com/GVAHCK',
  },
  {
    id: 'path-finder',
    title: 'Path Finder — Assistive Android Application',
    status: 'Showcase',
    statusVariant: 'showcase',
    description:
      'Built a navigation assistance application for visually impaired users using real-time object detection and audio guidance.',
    techStack: ['Android Studio', 'Python', 'Computer Vision', 'TensorFlow'],
    githubLink: 'https://github.com/GVAHCK',
  },
];
